...
export function AgencyPipeline() {
  ...
  useEffect(() => {
    ...
    setCurrentJob(jobs.find(j => j.id === selectedJobOrderId) || null);
  }, [selectedJobOrderId, jobs]);
  ...
  if (!selectedJobOrderId) {
    return (
      <div className="p-4 md:p-6 max-w-5xl mx-auto">
        <h1 className="text-2xl font-bold mb-6">{t('agency.pipeline.title')}</h1>
        {loading ? (
  ...
  return (
    <div className="p-4 md:p-6">
      <div className="flex items-center gap-3 mb-4">
        ...
        <div>
          <h1 className="text-xl font-bold">{currentJob?.title || 'Pipeline'}</h1>
