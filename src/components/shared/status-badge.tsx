...
const statusColors: Record<string, string> = {
  ...
  interview_scheduled: 'bg-purple-100 dark:bg-purple-950/50 text-purple-700 dark:text-purple-300',
  interview_passed: 'bg-emerald-100 dark:bg-emerald-950/50 text-emerald-700 dark:text-emerald-300',
  pending_documents: 'bg-orange-100 dark:bg-orange-950/50 text-orange-700 dark:text-orange-300',
  documents_submitted: 'bg-teal-100 dark:bg-teal-950/50 text-teal-700 dark:text-teal-300',
  pending_fira_review: 'bg-indigo-100 dark:bg-indigo-950/50 text-indigo-700 dark:text-indigo-300',
  fira_approved: 'bg-green-100 dark:bg-green-950/50 text-green-700 dark:text-green-300',
  pending_employer_review: 'bg-cyan-100 dark:bg-cyan-950/50 text-cyan-700 dark:text-cyan-300',
  employer_accepted: 'bg-lime-100 dark:bg-lime-950/50 text-lime-700 dark:text-lime-300',
  deployed: 'bg-emerald-200 dark:bg-emerald-950/50 text-emerald-800 dark:text-emerald-200',
