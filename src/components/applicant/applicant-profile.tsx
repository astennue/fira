  ...
  return (
    <div className="p-4 md:p-6 max-w-3xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-bold">{t('applicant.profile.title')}</h1>
        <Button
          ...
          disabled={saving}
        >
          {saving ? 'Saving...' : editing ? <><Save className="h-4 w-4 mr-1" />{t('common.save')}</> : <><Pencil className="h-4 w-4 mr-1" />{t('applicant.profile.edit')}</>}
        </Button>
      </div>
      ...
      {!editing && profile.skills && profile.skills.length > 0 && (
        <Card className="mt-4">
          <CardHeader className="pb-2"><CardTitle className="text-sm flex items-center gap-2"><Star className="h-4 w-4 text-emerald-600" />Skills</CardTitle></CardHeader>
      ...
      {!editing && profile.experience && profile.experience.length > 0 && (
        <Card className="mt-4">
          <CardHeader className="pb-2"><CardTitle className="text-sm flex items-center gap-2"><Briefcase className="h-4 w-4 text-emerald-600" />Work Experience</CardTitle></CardHeader>
      ...
      {!editing && profile.languages && profile.languages.length > 0 && (
        <Card className="mt-4">
          <CardHeader className="pb-2"><CardTitle className="text-sm flex items-center gap-2"><Globe className="h-4 w-4 text-emerald-600" />Languages</CardTitle></CardHeader>
          <CardContent className="flex flex-wrap gap-2">
